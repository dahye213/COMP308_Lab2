...
const UPDATE_STUDENT = gql`
  mutation UpdateStudent($id: String!, $studentNumber:String!, $firstName: String!, $lastName: String!, $address: String!, 
    $city: String!, $phoneNumber: String!, $email: String!, $program: String!) {
    updateStudent(id: $id, studentNumber:$studentNumber, firstName: $firstName, lastName: $lastName, address: $address, city: $city
...
{
    const [student, setStudent] = useState({ id: '', studentNumber:'',firstName: '', lastName: '', address: '', city: ''
